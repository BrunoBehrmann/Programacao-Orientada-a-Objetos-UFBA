...
var h1 = new Hospital(34, 'Hospital Sul');
...
var f01: Funcionario = new Medico('João', 50, 10, true); // assim se faz o casting para informar que o médico é um funcionário
...
SalarioExtra.registrar(h1.getDepartamento[0].getFuncionarios[0]);
...
e imprime o mesmo no console */
SalarioExtra.registrar(h1.getDepartamento[0].getFuncionarios[1])
